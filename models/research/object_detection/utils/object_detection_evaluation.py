...
class PascalDetectionEvaluator(ObjectDetectionEvaluator):
  ...
  def __init__(self, categories, matching_iou_threshold=0.33):
...
class ObjectDetectionEvaluation(object):
  ...
  def evaluate(self):
    ...
    try:
        print('self.use_weighted_mean_ap = %d' % self.use_weighted_mean_ap)
    except:
        print('self.use_weighted_mean_ap Error')
    ...
    print('=========================================================')
    print('=====AP==========AR=====')
    for x_per_class in range(len(self.recalls_per_class)):
        print(self.average_precision_per_class[x_per_class], np.mean(self.recalls_per_class[x_per_class]))
    print('=========================================================')
    ...
    print(self.precisions_per_class)
    print('=========================================================')
    print('recalls_per_class')
    print(self.recalls_per_class)
    print('=========================================================')
    print('corloc_per_class')
    print(self.corloc_per_class)
    print('=========================================================')
    print('mean_corloc')
    print(mean_corloc)
    print('=========================================================')
    ...
    try:
        scores_per_class_len = len(self.scores_per_class)
        print(scores_per_class_len)
        for x in range(scores_per_class_len):
            print(len(self.scores_per_class[x]))
    except:
        print('scores_per_class Error')
    print('=========================================================')

    try:
        for x_per_class in range(len(self.precisions_per_class)):
            print((self.precisions_per_class[x_per_class]).shape)
        print('++++++++++')
        for x_per_class in range(len(self.precisions_per_class)):
            print(np.mean(self.precisions_per_class[x_per_class]))
        print('++++++++++')
        for x_per_class in range(len(self.recalls_per_class)):
            print(np.mean(self.recalls_per_class[x_per_class]))
        print('++++++++++')
    except:
        print("shape Error")
    ...
    with open('log1.txt','w') as log:
        log.writelines('=================\n')
        log.writelines('average_precision_per_class\n')
        log.writelines(str(self.average_precision_per_class))
        log.writelines('\n')
        log.writelines('=================\n')
        log.writelines('mean_ap\n')
        log.writelines(str(mean_ap))
        log.writelines('\n')
        log.writelines('=================\n')
        log.writelines('precisions_per_class\n')
        log.writelines(str(self.precisions_per_class))
        log.writelines('\n')
        log.writelines('=================\n')
        log.writelines('recalls_per_class\n')
        log.writelines(str(self.recalls_per_class))
        log.writelines('\n')
        log.writelines('=================\n')
        log.writelines('corloc_per_class\n')
        log.writelines(str(self.corloc_per_class))
        log.writelines('\n')
        log.writelines('=================\n')
        log.writelines('mean_corloc\n')
        log.writelines(str(mean_corloc))
        log.writelines('\n')
        log.writelines('=================\n')
    ''' 
